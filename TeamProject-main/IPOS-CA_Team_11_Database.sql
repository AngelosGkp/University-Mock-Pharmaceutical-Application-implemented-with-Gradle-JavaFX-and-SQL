...
-- TABLE 4b: FLEXIBLE_DISCOUNT_TIERS
-- Stores the tiered rates for flexible discount plans
-- e.g. <£100: 0%, £100-£300: 1%, £300+: 2%

CREATE TABLE flexible_discount_tiers (
    tier_id INT AUTO_INCREMENT PRIMARY KEY,
    plan_id INT NOT NULL,
    min_amount DECIMAL(10,2) NOT NULL,
    max_amount DECIMAL(10,2),           -- NULL means no upper limit
...
INSERT INTO discount_plans (plan_name, discount_type, discount_percentage, description) VALUES
('Fixed 3%', 'Fixed', 3.00, 'Fixed 3% discount on all purchases');

INSERT INTO discount_plans (plan_name, discount_type, description) VALUES
('Variable Volume', 'Flexible', 'Volume-based: 0% under £100, 1% £100-£300, 2% over £300');

-- Flexible tiers for plan_id 2 (Variable Volume)
INSERT INTO flexible_discount_tiers (plan_id, min_amount, max_amount, discount_percentage) VALUES
(2, 0.00,   99.99,  0.00),
